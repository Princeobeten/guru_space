...
export const BookingPDF = ({ booking, firstName, lastName, email, phone }: { booking: Booking, firstName: string | undefined | null, lastName: string | undefined | null, email: string | undefined | null, phone: string | undefined | null }) => {
